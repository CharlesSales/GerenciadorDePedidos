...
export default function CarrinhoPage() {
  ...
  // Redirecionar para a página de produtos com view carrinho
  useEffect(() => {
    router.push('/produtos');
    // Após redirecionar, settar a view como carrinho via URL params ou state
    setTimeout(() => {
      const event = new CustomEvent('setCarrinhoView');
...
//   // Redirecionar para a página de produtos com view carrinho
//   React.useEffect(() => {
//     router.push('/produtos?view=carrinho');
//   }, [router]);
